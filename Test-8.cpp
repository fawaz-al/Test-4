...
int main(){
    ...
    printDataBarang();
    cout << "=================================" << endl;
    cout << "Add First Double Linked List" << endl;
    cout << "=================================" << endl;
    addFirst("Sikat Gigi", 23, 7000);
    printDataBarang();
    cout << "=================================" << endl;
    cout << "Add Last Double Linked List" << endl;
    cout << "=================================" << endl;
    addLast("Sabun Mandi", 11, 12000);
    printDataBarang();
    cout << "=================================" << endl;
    cout << "Add MIddle Double Linked List" << endl;
    cout << "=================================" << endl;
    addMiddle("Pomade", 11, 20000, 6);
    printDataBarang();
    cout << "=================================" << endl;
    cout << "Remove Middle Double Linked List" << endl;
    cout << "=================================" << endl;
    removeMiddle(6);
    printDataBarang();
}